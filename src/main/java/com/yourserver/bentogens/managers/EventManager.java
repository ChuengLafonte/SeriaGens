...
public class EventManager {
    ...
    public EventManager(BentoGens plugin) {
        this.plugin = plugin;
    ...
    public abstract static class GeneratorEvent {
        ...
        public abstract void start(BentoGens plugin);
        public abstract void stop(BentoGens plugin);
    ...
    public static class SellMultiplierEvent extends GeneratorEvent {
        ...
        @Override
        public void start(BentoGens plugin) {
            plugin.getSellManager().setEventMultiplier(multiplier);
        }
        
        @Override
        public void stop(BentoGens plugin) {
